...
function Bot(authToken, options) {
  ...
  if (options.actionInterval === undefined) options.actionInterval = 3000;
...
Bot.prototype.processUpdate = function processUpdate(update) {
  ...
  if (update.message !== undefined) {
    ...
    this.processMessage(update.channel_post, false, true);
    delete update.channel_post;
  } else if (update.edited_channel_post !== undefined) {
    this.processMessage(update.edited_channel_post, true, true);
