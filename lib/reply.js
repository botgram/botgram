...
ReplyQueue.prototype.video = function video(file, duration, caption, width, height) {
  if (file instanceof model.File) file = file.id;
...
ReplyQueue.prototype.message = function message(msg, reforward) {
  ...
  if (msg.type === "video") return this.video(msg.file, msg.duration, msg.caption, msg.width, msg.height);
...
ReplyQueue.prototype.detached = function detached() {
  return new ReplyQueue(this.bot, {}, this.destination);
};
