...
function sendGeneric(method, additionalParameters) {
  ...
  return enqueueError.call(this.bot, this.id, this.bot.callMethod.bind(this.bot, method, parameters));
}
...
ReplyQueue.prototype.reply = function reply(message) {
  ...
  this.parameters["reply_to_message_id"] = id;
  return this;
};
...
ReplyQueue.prototype.keyboard = function keyboard(keys, resize, permanent, selective) {
  if (!this.parameters["reply_markup"]) this.parameters["reply_markup"] = {};
  var markup = this.parameters["reply_markup"];
  if (selective !== undefined) markup.selective = !!selective;
  ...
  markup.one_time_keyboard = !permanent;
  return this;
};
