...
ReplyQueue.prototype.sendGeneric = function sendGeneric(method, additionalParameters) {
...
ReplyQueue.prototype.photo = function photo(file, caption) {
  ...
  return this.sendGeneric("sendPhoto", {photo: file, caption: caption});
};

ReplyQueue.prototype.audio = function audio(file, duration, performer, title, caption) {
  file = model.resolveFile(file);
  return this.sendGeneric("sendAudio", {audio: file, duration: duration, performer: performer, title: title, caption: caption});
};

ReplyQueue.prototype.document = function document(file) {
  file = model.resolveFile(file);
  return this.sendGeneric("sendDocument", {document: file});
};
...
ReplyQueue.prototype.video = function video(file, duration, width, height, caption) {
  file = model.resolveFile(file);
  return this.sendGeneric("sendVideo", {video: file, duration: duration, caption: caption, width: width, height: height });
};

ReplyQueue.prototype.voice = function voice(file, duration, caption) {
  file = model.resolveFile(file);
  return this.sendGeneric("sendVoice", {voice: file, duration: duration, caption: caption});
};
...
ReplyQueue.prototype.action = function action(action) {
  ...
  return this.sendGeneric("sendChatAction", {action: action});
};
...
ReplyQueue.prototype.editText = function editText(msg, text, mode) {
  ...
  return this.sendGeneric("editMessageText", parameters);
};
...
ReplyQueue.prototype.editCaption = function editCaption(msg, caption) {
  ...
  return this.sendGeneric("editMessageCaption", parameters);
};
...
ReplyQueue.prototype.editReplyMarkup = function editReplyMarkup(msg) {
  ...
  return this.sendGeneric("editMessageReplyMarkup", parameters);
};
